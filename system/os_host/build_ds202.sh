...
INCLUDES="\
  ...
  -I ../library/STM32F30x_StdPeriph_Driver/inc \
  -I .. \
  -I ../source \
  -I ../library/CMSIS/Device/STM32F30x/Include \
  -I ../library"

#arm-none-eabi-gcc -mcpu=cortex-m3 -mthumb -c ../source/bios/ds202/BIOS.s -o BIOS.o
...
arm-none-eabi-gcc -Wall -Os -Werror -fno-common -mcpu=cortex-m3 -mthumb -msoft-float -MD \
  ...
  ../source/startup.c \
  ../source/interrupt.c \
  ../library/CMSIS/Device/STM32F30x/Source/system_stm32f30x.c \
  ../source/bios/imports.c \
  ../library/STM32F30x_StdPeriph_Driver/src/stm32f30x_misc.c
...
arm-none-eabi-gcc -mcpu=cortex-m3 -mthumb -o output.elf -nostartfiles -T ../app_ds202.ld \
  ./main.o \
  ./startup.o \
  ./interrupt.o \
  ./sys.o \
...
arm-none-eabi-objcopy -O ihex ./output.elf ./system_ds202.hex
