...
//=====+========+========+========+========+========+========+========+========+
//Item:|三角波表|锯齿波表|采样计数|采样计数|输入按键|
//-----+--------+--------+--------+--------+--------+--------+--------+--------+
// RET:|   u16* |   u16* |   u16  |   u16  |   u8   |
//-----+--------+--------+--------+--------+--------+--------+--------+--------+
        TRG_TAB, SAW_TAB, CHA_CNT, CHB_CNT,  KEY_IN,};
//=====+========+========+========+========+========+========+========+========+

#define K_PWR             0x01     /* 电源开关键 */
#define K_RUN             0x02     /* RUN键      */
#define K_DFU             K_PWR
#define DFU_KEY_ST()      PWR_KEY_ST()
...
//=====+========+========+========+========+========+========+========+========+
//Item:| CHA量程| CHB量程| CHA偏移| CHA偏移|触摸复位|
//-----+--------+--------+--------+--------+--------+--------+--------+--------+
// Val:|   0~1  |   u8   | 0~4095 | 0~4095 |    0   | 
//-----+--------+--------+--------+--------+--------+--------+--------+--------+
        AiRANGE, BiRANGE, AOFFSET, BOFFSET,  TP_RST,};
//=====+========+========+========+========+========+========+========+========+
...
//-----+-----------------+-----------------+-----------------+-----------------+
          I2C_SPI = 0x10,   ADC_DAC = 0x20,   LCD_DEV = 0x40,  USB_DISK = 0x80,};
//=====+=================+=================+=================+=================+
...
#define TP_RST_HIGH()     GPIOD->BSRR = RST_TP
#define TP_RST_LOW()      GPIOD->BRR  = RST_TP

//----------------------- Ext Flash 控制相关宏定义 -----------------------------

#define ExtFlash_CS_HIGH()  GPIOD->BSRR = SPI_CS
#define ExtFlash_CS_LOW()   GPIOD->BRR  = SPI_CS
