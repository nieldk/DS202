...
#include <stdbool.h>
#ifdef DS202
  #include "source/bios/ds202/imports.c"
  #include "library/STM32F30x_StdPeriph_Driver/inc/stm32f30x_misc.h"
...
#if defined(DISABLE_USB) || defined(DS203) || defined(DS203HD) || defined(DS202)
